...
export default function ShareButtons({ title }: Props) {
  ...
  return (
    <div className="flex flex-wrap gap-3 items-center" dir="rtl">
      <span className="text-sm font-semibold text-[#5C6E55]">
        شارك المقالة:
      </span>
      ...
      {shareLinks.map((link) => {
        ...
        return (
          <a
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md ${link.bg}`}>
